...
namespace fxCoreLinkTests
{
    ...
    public class SimulatorTests
    {
        ...
        public SimulatorTests()
        {
            ...
            position.createPosition(pairAU, new DateTime(2015, 1, 1, 1, 1, 1, 0), "BUY", 1000, entryPriceAU, "id-1");
            ...
            position.createPosition(pairAJ, new DateTime(2015, 1, 1, 1, 1, 1, 0), "SELL", 1000, entryPriceAJ, "id-1");
        ...
        public void TestHitLimit()
        {
            ...
            for (int i = 0; i < 59; i++)
            {
                ...
                order.processOrders(pairAU, nowDt, price);
            }
        ...
        public void TestOpenOpposingLongPosition()
        {
            ...
            position.createPosition(pairAU, new DateTime(2015, 1, 1, 1, 3, 1, 0), "SELL", 1000, entryPrice2, "id-1");
            double pips = closedTrade.getClosedPositionGross(pairAU);
        ...
        public void TestOpenOpposingShortPosition()
        {
            ...
            position.createPosition(pairAJ, new DateTime(2015, 1, 1, 1, 3, 1, 0), "BUY", 1000, entryPrice2, "id-1");
